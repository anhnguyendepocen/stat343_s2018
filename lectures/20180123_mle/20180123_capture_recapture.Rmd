...
Pour 100 Cheddar goldfish into a ziplock bag.  This represents the population of fish in the pond.  For the rest of this exercise, we're going to pretend that we don't know the total number of fish in the pond and we're going to try to estimate that number.
