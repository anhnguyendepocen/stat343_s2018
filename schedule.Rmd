 ...
 * **Before class**, please do the following:
    ...
    * **Sign up** for our class at Piazza (anonymous question and answer forum): [piazza.com/mtholyoke/spring2018/stat343](piazza.com/mtholyoke/spring2018/stat343)
    * **Reading**
 ...
 * **In class**, we will work on:
    * Finish off any remaining material from Tuesday.
 ...
 * **In Class**, we will work on:
    * Maximum likelihood and Bayesian Estimation for a univariate normal with known variance?  Depends on how far we got on Thursday.
"
  )
```
