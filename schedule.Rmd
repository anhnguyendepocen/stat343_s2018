 ...
 * **In class**, we will do the following:
    * Start on normal approximation to the sampling distribution of the MLE.
        ...
        * [Notebook viewer](http://nbviewer.jupyter.org/urls/cdn.rawgit.com/mhc-stat343-s2018/lecture-mle-sampling-dist-normal-approx/dae64168/exponential_loglik_plots.ipynb) - to just look at example from class
"
  )
```
